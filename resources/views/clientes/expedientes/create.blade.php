...
<body class="bg-gray-100 text-gray-800 p-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        {{-- CORREGIDO: Usamos la propiedad 'Nombre' del objeto $cliente --}}
        ...
        <form action="{{ route('expedientes.store') }}" method="POST" class="space-y-6">
            ...
            {{-- CORREGIDO: Pasamos la clave 'NºRef' del cliente al controlador --}}
            ...
            <div class="mt-8 pt-6 border-t flex justify-end space-x-4">
                <a href="{{ route('clientes.expedientes.index', $cliente) }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold px-6 py-2 rounded-md transition">
                    Cancelar
                </a>
